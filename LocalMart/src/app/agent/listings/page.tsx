...
export default async function AgentListingsPage({ searchParams }: Props) {
  ...
  const buildUrl = (extra: Record<string, string | undefined>) => {
    ...
    return `/agent/listings?${p.toString()}`;
  };
  ...
  return (
    <div className="space-y-5 animate-fade-in">
      ...
      <div className="card p-4 space-y-3">
        <form method="GET" action="/agent/listings" className="flex gap-2">
